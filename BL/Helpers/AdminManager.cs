...
internal static class AdminManager //stage 4
{
    ...
    internal static void UpdateClock(DateTime newClock) //stage 4-7
    {
        ...
        // function to make the requiered updates to the assignments based on the new current time (newClock)
        if (_periodicTask is null || _periodicTask.IsCompleted) //stage 7
            _periodicTask = Task.Run(() => CallManager.PeriodicAssignmentsUpdates(newClock));
    ...
    private static void clockRunner()
    {
        ...
        { 
            ...
            if (_simulateTask is null || _simulateTask.IsCompleted)//stage 7
                _simulateTask = Task.Run(() => VolunteerManager.volunteerSimulation()); //change to our - VolunteerManager.Simulate())
